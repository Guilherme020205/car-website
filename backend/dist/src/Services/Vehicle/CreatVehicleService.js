...
function CreatVehicleService(model, mark_id, exchange_id, fuel_id, bodyWork_id, km, year, price, description_id, baner1, baner2, baner3, baner4, baner5) {
    return __awaiter(this, void 0, void 0, function () {
        var description, createdVehicle;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.descripitons.create({
                        data: {
                ...
                case 1:
                    description = _a.sent();
                    return [4 /*yield*/, prisma_1.default.vehicles.create({
                            data: {
                                model: model,
                                mark_id: mark_id,
                ...
                case 2:
                    ...
                    return [2 /*return*/, createdVehicle];
            }
        });
    });
}
