...
var DeletContactService_1 = require("../../Services/Contatos/DeletContactService");
function DeletContactController(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var idContact, deletContact, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, DeletContactService_1.DeletContactService)(idContact)];
                case 1:
                    deletContact = _a.sent();
